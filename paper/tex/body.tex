...
The secondary backbone the protocol named, VGG16, was not computed; the reason
and its recorded status are in Methods, and nothing is imputed for it.
...
protocol named is recorded as not computed, and the result describes what this
...
The perceptual computation is the one named in Methods, on the \SubsetN{}
crops. The VGG16 backbone the protocol named is recorded as not computed, no
distortion-free quality score stands in for it, and every perceptual value in
this paper belongs to one of those crops.
...
of the perceptual pass, and the predeclaration, nine-cell summary, independent
