...
Two bound paths hold the record for the bicubic arm. Comparing their digests
...
line of work would eventually be measured against was never produced, and both
the tier that would hold it and the tier above it are recorded as
\PrimaryTier{} and \SotaTier{}. Completing the subset does not change either,
the records say so in their own words, and this paper does not present the
