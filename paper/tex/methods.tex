...
tied to the manuscript by an evidence-manifest binding; the figure code verifies
each bound file before reading it and stops the build on any mismatch. No model was
...
subset as an approximation of the full comparison. The scored \SubsetN{} crops
are the published crop128 protocol; the memory skip belongs to the earlier
census, not to that protocol.
