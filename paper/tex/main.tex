...
Table~\ref{tab:toy} and Figure~\ref{fig:toy} give the toy-scale run as its own
...
Figure~\ref{fig:budget} adds the one arm that tests whether the toy shortfall was
...
Figure~\ref{fig:subset} plots the comparison crop by crop. The model is behind
...
produce. Figure~\ref{fig:paired} draws that width as a band so the two scales can
...
Table~\ref{tab:census} and Figure~\ref{fig:ceiling} give what that removed. The
